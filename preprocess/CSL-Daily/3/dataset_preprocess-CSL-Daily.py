...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='CSL-Daily',
                        help='save prefix')
    parser.add_argument('--dataset-root', type=str, default='/remote-home/cs_cs_zl/TwoStreamNetwork/data/csl-daily/sentence/frames_512x512',
                        help='path to the dataset')
    parser.add_argument('--target-path', type=str, default='/remote-home/cs_cs_zl/TwoStreamNetwork/dataset/CSL-Daily_256x256px',

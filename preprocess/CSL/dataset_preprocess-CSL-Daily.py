...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='home/ly612/workdir/HSTENet/preprocess/CSL-Daily',
                        help='save prefix')
    parser.add_argument('--dataset-root', type=str, default='/home/ly612/workdir/HSTENet/data/csl-daily/sentence/frames_512x512',
                        help='path to the dataset')
    parser.add_argument('--target-path', type=str, default='/home/ly612/workdir/HSTENet/dataset/CSL-Daily_256x256px',
    ...
    res_path="/remote-home/cs_cs_zl/TwoStreamNetwork/data/csl-daily/sentence_label"
